                         ...
                         TextureCacheType*  pTextureCache)
{
...

    {
        ...
        VBDesc.BindFlags     = BIND_VERTEX_BUFFER | BIND_UNIFORM_BUFFER;
    ...
    if (!IndexBuffer.empty())
    {
        ...
        IBDesc.BindFlags     = BIND_INDEX_BUFFER | BIND_UNIFORM_BUFFER;
    ...
    {
        {pVertexBuffer[0], RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_VERTEX_BUFFER, true},
        {pVertexBuffer[1],  RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_VERTEX_BUFFER, true},
        {pIndexBuffer,  RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_INDEX_BUFFER, true}
    };
    // clang-format on
