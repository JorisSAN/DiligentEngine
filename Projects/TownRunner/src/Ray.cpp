...
Ray::Ray(const SampleInitInfo& InitInfo, BackgroundMode backGround, RefCntAutoPtr<IRenderPass>& RenderPass) :
...
void Plane::RenderActor(const Camera& CameraViewProj, bool IsShadowPass)
{
    {
        struct Constants
        {
